...
enum GitRouter {
    ...
    var baseURL: String {
        switch self {
        case .fetchUserRepositories, .searchRepositories, .fetchCommits, .fetchUserData, .fetchStarredRepositories, .fetchUserFollowers, .fetchUserFollowing, .fetchFollowers:
